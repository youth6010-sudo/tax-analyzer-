...
export const TOKENS: TemplateToken[] = [
  ...
  { token: '{특이사항}', desc: '안내문: 없으면 삭제 / 있으면 줄바꿈+특이사항+줄바꿈' },
];
...
export const VAT_REPORT_TOKENS: TemplateToken[] = [
  ...
  { token: '{신고결과부가정보}', desc: '없으면 줄바꿈만 / 있으면 줄바꿈+직원·차량 등+줄바꿈' },
  { token: '{분납안내}', desc: '없으면 줄바꿈만 / 있으면 줄바꿈+분납 일정+줄바꿈' },
];

export const DEFAULT_VAT_REPORT_TEMPLATE = `<div style="line-height:1.55;">
<b style="font-size:15px;">📋 부가가치세 신고 결과 보고</b><br>
<br>
{귀속} {세목} 신고 결과 및 매입매출장을 전달드립니다.<br>
아래 신고 내용과 첨부 자료 확인 부탁드립니다.<br>
<br>
[신고 결과 요약]<br>
